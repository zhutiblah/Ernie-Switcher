...
def main():
    ...
    try:
        for epoch in range(50, 150, 50):
            ...
            model_path = f'/home/lirunting/lrt/sample/Prediction_Translation_Strength/Synthesizing_mRNA/result/Switch-ddpm-2025-11-28-16-46-iteration-{epoch}-model.pth'
            ...
            make_fasta_file(sequences,path=f'../sequence/112816weight0_Switche_epoch={epoch}_6_mer_fre_cor={k_mer_fre_cor}.fasta')
